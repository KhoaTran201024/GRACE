...
fh = logging.FileHandler('bigvulmetricsgpt4.log')
    ...
    with open('C:/Users/khoiv/Downloads/MSR_data_cleaned.csv', newline='', encoding='utf-8') as csvfile:
        ...
        for i, row in enumerate(reader):
            ...
            #     inputex = row['example'][:4000]
                ...
                with open('bigvulresultsgpt4.csv', 'a', newline='') as f:
                    writer = csv.writer(f)
            ...
            #         prediction = 2
                ...
                ground_truth.append(int(row['vul']))
                # print(inputCode)
                # print(inputnode)
                # print(inputedge)

            with open('bigvulresultsgpt4.csv', 'w', newline='') as f:
                writer = csv.writer(f)
